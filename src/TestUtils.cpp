...
void QueryResultsHandler::onCypherQueryStarts(std::string const & cypherQuery)
{
...
void QueryResultsHandler::onOrderAndColumnNames(const GraphDB::ResultOrder& ro, const std::vector<openCypher::Variable>& vars, const GraphDB::VecColumnNames& colNames) {
  m_resultOrder = ro;
  m_variables = vars;
  m_columnNames = colNames;
}

void QueryResultsHandler::onRow(const GraphDB::VecValues& values)
{
